...
int main(int argc, const char **argv) {
  ...
  float end_x;
  float end_y;
  std::cout << "Please write  the start_x" << std::endl;
  std::cin >> start_x;
  std::cout << "Please write  the start_y" << std::endl;
  std::cin >> start_y;
  std::cout << "Please write  the end_x" << std::endl;
  std::cin >> end_x;
  std::cout << "Please write  the end_y" << std::endl;
  std::cin >> end_y;
